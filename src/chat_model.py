...
class movie_chat_model(Model):
  ...
  def initialize_query_constructor(self):
    document_content_description = "Berif overview os a movie, along with keywords."
  ...
  def initialize_vector_store(self):
    ...
    pc_index = pc.Index("rag-movie-recommender-sentence-transformer")
  ...
  def initialize_chat_model(self, config):
    ...
    # Create a chatbo Question & Answer chain from the retriever
    rag_chain_from_docs = (
  ...
  def predict_stream(self, query: str):
    ...
    try:
      ...
      return {'answer': f"An error occured: {e}"}
